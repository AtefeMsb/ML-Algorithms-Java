...
//        samples.add(new int[]{0, 30, 1});
//
//        int[] query = new int[]{0, 4};
//        int[] query2 = new int[]{1, 40};
//
//        DecesionTree tree = new DecesionTree(1, 4);
//        Node root = tree.fit(samples, 0);
//        int y = tree.predict(query2, root);
...
//        this.root = new Node(0, 0, null, null, 0);
//    }
//
//    public Node fit(List<int[]> samples, int curDepth) {
//
